...
class Events_model extends CI_Model {
    ...
    public function get( $value ) {
        $this->db->from($this->table);
        $this->db->group_start()->or_where(['evn_id' => $value, 'evn_name' => $value])->group_end();
        $query = $this->db->get();
    ...
    public function update( $id, $data ) {
        return $this->_update($this->table, ['evn_id' => $id], $data);
    }

    public function delete( $id ) {
        return $this->_delete($this->table, ['evn_id' => $id]);
    }
